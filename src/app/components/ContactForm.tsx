    ...
    return (
        <div className="bg-[#394649] text-center w-screen p-4">
            <div className="w-full px-4 sm:px-6 lg:px-8 p-10">
                <h1 className='text-white font-bold text-4xl md:text-5xl lg:text-6xl py-10'>
                ...
                <form className='mt-5'>
                    <input type="text" placeholder='Мобилен Телефон' className='h-12 text-[#083C2F] p-4 border rounded-l ' />
